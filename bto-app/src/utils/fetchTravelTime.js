 ...
 */
export const fetchTravelTime = async (startLat, startLng, endLat, endLng, mode) => {
    // Validate the mode parameter
    if (mode !== 'car' && mode !== 'pedestrian' && mode !== 'bicycle') {
        throw new Error('Invalid mode. The mode parameter must be either "car" or "pedestrian" or "bicycle.');
    }
