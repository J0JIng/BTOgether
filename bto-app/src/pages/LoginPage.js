    ...
    <div className="login-page">
      ...
      <div className='title-and-box'>
        <div className="title-and-sign-up">
            ...
            {isSignUpActive && <a className='loginpage redirect' onClick={handleMethodChange}>Have an account? Login here</a>}
            {!isSignUpActive && (<a className='registerpage redirect' onClick={handleMethodChange}>Don't have an account? Register here</a>)}
