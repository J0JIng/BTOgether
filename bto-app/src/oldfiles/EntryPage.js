            ...
            <div className='logos'>
                <div className="top">
                    <div className="planner-container logo-block">
                        ...
                        <div className='logo-description'>Some words that will become the description of the image and show of the features of out website</div>
                    </div>
                    <div className="dashboard-container logo-block">
                        <img src={Dashboard} alt='Dashboard' style={{ width: '225px', height: '225px', borderRadius: '5px' }} />
                ...
                <div className="bottom">
                    <div className="easy-container logo-block">
                        <img src={Easy} alt='Easy To Search' style={{ width: '225px', height: '225px', borderRadius: '5px' }} />
                        <div className="header">Easy to Use</div>
                        <div className='logo-description'>Some words that will become the description of the image and show of the features of out website</div>  
                    </div>
                    <div className="search-container logo-block">
                        <img src={Search} alt='Search Function' style={{ width: '225px', height: '225px', borderRadius: '5px' }} />
