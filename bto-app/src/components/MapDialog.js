...
export default function MapDialog({ type, locationInfo }) {
    ...
    const homeIcon = new Icon({ iconUrl: require("../icons/home-button.png"), iconSize: [36, 36] });
        ...
        try {
            ...
            if (geocodingResponse.data.length > 0) {
                ...
                if (
                    ...
                    setErrorMessage('The location of is outside Singapore. Please refine your search.');
                    setCanSubmit(false)
                }
            } else {
        ...
        <React.Fragment>
            ...
            >
                ...
                <DialogActions style={{ marginBottom: '10px', marginRight: '10px' }}>
                    ...
                    <Button onClick={handleClose} variant='contained' disabled={!canSubmit}>
                        Confirm
                    </Button>
                </DialogActions>
            </Dialog>
