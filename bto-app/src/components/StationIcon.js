...
const OneCodeButton = ({ stationCode }) => {
  ...
  useEffect(() => {
    if (stationCode.includes("NS")) {
        ...
        setBg("#009645"); setText("white");
    } else if (stationCode.includes("NE")) {
        setBg("#9900aa"); setText("white");
    } else if (stationCode.includes("CC") || stationCode.includes("CE")) {
        setBg("#fa9e0d"); setText("black");
    } else if (stationCode.includes("DT")) {
        setBg("#005ec4"); setText("white");
    } else if (stationCode.includes("TE")) {
        setBg("#9D5B25"); setText("white");
    } else if (stationCode.includes("BP") || stationCode.includes("SE") || stationCode.includes("SW") || stationCode.includes("PE") || stationCode.includes("PW")|| stationCode.includes("STC")|| stationCode.includes("PTC")) {
        setBg("#748477"); setText("white");
    } else if (stationCode.includes("CR") || stationCode.includes("CP")) {
        setBg("#97C616"); setText("black");
    } else if (stationCode.includes("JS") || stationCode.includes("JW") || stationCode.includes("JE") || stationCode.includes("JW")) {
        setBg("#0099aa"); setText("white");
    } else if (stationCode.includes("RTS")) {
        setBg("#87CEFA"); setText("black");
    }
  }, [stationCode]);
    ...
    useEffect(() => {
      ...
      const segmentColors = stationSegments.map(segment => {
        if (segment.includes("NS")) {
            ...
            return("#9D5B25");
        } else if (segment.includes("BP") || segment.includes("SE") || segment.includes("SW") || segment.includes("PE") || segment.includes("PW")|| segment.includes("STC")|| segment.includes("PTC")) {
            return("#748477");
        } else if (segment.includes("CR") || segment.includes("CP")) {
            return("#97C616");
        } else if (segment.includes("JS") || segment.includes("JW") || segment.includes("JE") || segment.includes("JW")) {
            return("#0099aa");
      ...
      const segmentTextColors = stationSegments.map(segment => {
        if (segment.includes("CC") || segment.includes("CE") || segment.includes("CR") || segment.includes("CP")) {
            return("black");
        } else if (segment.includes("RTS")) {
            return("black");
        } else {
